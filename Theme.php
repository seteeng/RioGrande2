...
class Theme extends BaseV1\Theme{
    ...
    protected static function _getTexts(){
        ...
        return [
            ...
            'site: description' => 'SMCULTRG', //App::i()->config['app.siteDescription'],
            ...
            'home: title' => "Bem-vind@ ao Mapa Cultural de Rio Grande!", //. App::i()->config['app.siteName'],
            'home: abbreviation' => "SMCULTRG",
